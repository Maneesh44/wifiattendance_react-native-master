          ...
          <SafeAreaView >
            <View >
              <Calendar
                ...
                onDayPress={(day) => {
                  ...
                  this.setState({
                    dateSelected: day, leaveFrom: day,
                    toggle:true, count: this.state.count + 1
                  }),
            ...
            <View style={{ top: 25 }}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                <Text style={{ fontSize: 18, lineHeight: 40, left: 10 }}>Total Selected Leaves :{this.state.count}</Text>
                {!this.state.toggle?
